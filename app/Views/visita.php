...
<script>
  ...
  function viewPDF(id_visita) {
    // Lógica para visualizar el PDF del id_visita seleccionado en línea
    window.location.href = 'http://localhost/codeigniter/public/uploads/visita_' + id_visita + '.pdf';
}
